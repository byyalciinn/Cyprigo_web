import { ArrowRight, MapPin, Phone, Mail, Instagram, Youtube, Facebook } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
              {/* Quick Links */}
              <div>
                <h4 className="text-foreground font-semibold text-lg mb-6">Hızlı Linkler</h4>
              ...
              {/* Tour Links */}
              <div>
                <h4 className="text-foreground font-semibold text-lg mb-6">Turlarımız</h4>
                <ul className="space-y-4">
                  {tourLinks.map((link) => (
                    <li key={link.name}>
                      <a 
              ...
              {/* Newsletter */}
              <div>
                <h4 className="text-foreground font-semibold text-lg mb-6">Bülten</h4>
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-base">
                Gizlilik Politikası
              </a>
              <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-base">
                Kullanım Şartları
