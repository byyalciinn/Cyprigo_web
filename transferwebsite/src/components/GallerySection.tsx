    ...
    <section className="section-padding bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <span className="text-muted-foreground text-sm tracking-wider">Galeri</span>
          <div className="h-px w-16 bg-border" />
        </div>
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-center mb-12 max-w-3xl mx-auto leading-tight">
          ...
          <span className="text-muted-foreground">Kültürü ve Anları Fotoğraflarda</span>
        </h2>
        ...
        <p className="text-center text-muted-foreground max-w-3xl mx-auto mt-12 leading-relaxed">
          Özenle seçilmiş galerimizle Kuzey Kıbrıs'a adım atın. Ülke genelindeki yolculuklarımızdan güzelliği, kültürü 
          ve unutulmaz anları yakalıyoruz. İkonik simge yapılardan gizli hazinelere, her görüntüde Kuzey Kıbrıs'ı deneyimleyin.
        </p>
      </div>
    </section>
  );
