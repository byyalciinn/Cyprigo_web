  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-foreground/20 bg-transparent hover:bg-foreground/5 text-foreground rounded-full",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-full",
        ghost: "hover:bg-accent hover:text-accent-foreground rounded-lg",
        link: "text-foreground underline-offset-4 hover:underline",
        premium: "bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-full shadow-sm hover:shadow-md",
        premiumOutline: "border border-foreground/15 bg-transparent hover:bg-foreground/5 text-foreground rounded-full",
