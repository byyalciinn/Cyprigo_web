    ...
    <section id="about" className="section-padding bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <span className="text-muted-foreground italic text-base">Hakkımızda</span>
          <div className="h-px flex-1 max-w-32 bg-border" />
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-12">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-foreground leading-tight max-w-lg">
            Neden{" "}
            <span className="text-muted-foreground">Cyprigo'yu Tercih Etmelisiniz?</span>
          </h2>

          {/* Right - Description + Button */}
          <div className="max-w-md">
            <p className="text-muted-foreground mb-6">
              Kuzey Kıbrıs'ın güzelliklerini keşfetmek için güvenilir partneriniz. 
              Konfor, güvenlik ve unutulmaz deneyimler için buradayız.
            </p>
