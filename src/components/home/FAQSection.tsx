          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-foreground leading-tight mb-4">
              ...
              <span className="text-muted-foreground">
                hakkında tüm cevaplar için SSS bölümümüzü keşfedin.
              </span>
            </h2>

            <p className="text-muted-foreground mb-10">
              Size yardımcı olmak için buradayız! Mükemmel seyahatinizi
              planlamak için ihtiyacınız olan tüm bilgileri SSS bölümümüzde
              bulabilirsiniz.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-6 right-6 left-6 md:left-auto md:w-72 bg-background rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Mükemmel Kuzey Kıbrıs seyahatinizi planlamak için daha fazla
                yardıma mı ihtiyacınız var? Ekibimiz her türlü sorunuz için
                burada.
              </p>
              <Button
                variant="outline"
